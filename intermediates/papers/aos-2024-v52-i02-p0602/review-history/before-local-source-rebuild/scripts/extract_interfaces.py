...
add('D5',['long-run covariance matrix','long-run standard deviations'],r'''
Then the long-run covariance matrix of $\epsilon_t$ and the diagonal matrix of the long-run standard deviations are
\[
