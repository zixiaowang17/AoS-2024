...
members['D20']['highlight_symbols'] = ['T(H_2,-d_2^*(H_2))']
members['D20']['highlight_phrases'] = ['(13)']
members['D31']['highlight_symbols'] = ['\\mathcal U_{tn}']
members['D31']['highlight_phrases'] = ['(21)']
