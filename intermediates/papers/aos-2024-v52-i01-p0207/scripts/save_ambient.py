...
def main():
    ...
    add('A1',passage('For any $a,b\\in\\mathbb{R}$',r'\section{Problem formulation}'),6,
        ...
        'Ambient notation rather than an additional ranked interface. The PDF and matching TeX both print smallset; this spelling and the mathematical strict inequalities are retained.')
