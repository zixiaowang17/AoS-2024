...
prov={'paper_id': 'aos-2024-v52-i03-p1050', 'title': 'Change acceleration and detection', 'version': 'arXiv:1710.00915v5', 'source_url': 'https://arxiv.org/pdf/1710.00915v5', 'pdf_pages': 53, 'pdf_sha256': '532c26f11f178000a1e42bb7d8c43cfc1ea646168a22a4b3f63b255536ae4815'};claims=[]
...
def main():
    ...
    pdf=fitz.open(source);assert len(pdf)==53 and hashlib.sha256(source.read_bytes()).hexdigest()==paper['pdf_sha256']
