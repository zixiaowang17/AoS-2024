...
members['D1']['highlight_symbols'] = ['d=\\infty', '\\|\\boldsymbol A\\|']
members['D8']['highlight_symbols'] = ['\\boldsymbol X=\\begin{bmatrix}\\boldsymbol x_1^\\top\\\\\\boldsymbol x_2^\\top\\\\\\vdots\\\\\\boldsymbol x_n^\\top\\end{bmatrix}']
members['D11']['highlight_symbols'] = ['\\lambda\\to0+']
members['D28']['highlight_symbols'] = ['\\sum_{k=1}^{\\lfloor nx\\rfloor}', '\\int_0^\\infty x^\\alpha\\,dF_\\beta(x)']
members['D29']['highlight_symbols'] = ['\\sum_{k=1}^{\\lfloor(n/\\log n)x\\rfloor}', '\\int_0^\\infty x\\,dF_\\beta(x)']
