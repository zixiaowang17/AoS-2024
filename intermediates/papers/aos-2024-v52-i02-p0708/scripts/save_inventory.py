...
prov={'paper_id': 'aos-2024-v52-i02-p0708', 'title': 'Edge differentially private estimation in the β-model via jittering and method of moments', 'version': 'arXiv:2112.10151v2', 'source_url': 'https://arxiv.org/pdf/2112.10151v2', 'pdf_pages': 76, 'pdf_sha256': '612f5176eaea7e74f44be9d35dca9a9f567d07294108220ddb014ce31f038908', 'main_text_shared_page_cutoff_y': 313.6376953125}
claims=[]
...
def main():
    ...
    assert len(pdf)==76 and hashlib.sha256(source.read_bytes()).hexdigest()==paper['pdf_sha256']
