...
members['D16']['highlight_symbols'] = ["[\\mathcal I(\\psi)]_{d,d'}", '\\partial_{\\psi_d}\\log g(Y\\mid\\psi)']
members['D12']['highlight_symbols'] = ['t_{mix}^{(J)}(\\epsilon,M)', '\\sup_{\\mu\\in\\mathcal N(\\pi_J,M)}']
