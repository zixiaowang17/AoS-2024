...
REPO = ROOT.parents[3]
prov = {'paper_id': 'aos-2024-v52-i01-p0335', 'title': 'Adaptive variational Bayes: Optimality, computation and applications', 'version': 'arXiv:2109.03204v4', 'source_url': 'https://arxiv.org/pdf/2109.03204v4', 'pdf_pages': 94, 'pdf_sha256': '9485f32a3fe57433913bc7dc02d7a2ed126c977738472fceb3cbe57b33dad3c0'}
claims=[]
...
def main():
    ...
    assert hashlib.sha256(source.read_bytes()).hexdigest() == prov['pdf_sha256'], 'Registered source changed; review it before rebuilding.'
    import fitz
    ...
    print('Saved and structurally validated the reviewed fourteen-Theorem inventory; no new source review performed.')
