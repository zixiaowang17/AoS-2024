...
Denote $\widetilde{\mathbf x}_{t,k}=\sum_{i\in[d_{-k}]}\mathbf x_{t,-k,i}$, $\widetilde{\mathbf f}_{t,k}=\sum_{i\in[d_{-k}]}\mathbf f_{t,-k,i}$, $\widetilde{\mathbf e}_{t,k}=\sum_{i\in[d_{-k}]}\mathbf e_{t,-k,i}$ and $\widetilde{\boldsymbol\mu}_k=\sum_{i\in[d_{-k}]}\boldsymbol\mu_{-k,i}$. Define $\ddot{\mathbf f}_{t,k}=\widetilde{\mathbf f}_{t,k}/s_{-k}^{1/2}$, write $\ddot{\mathbf F}_k=[\ddot{\mathbf f}_{1,k},\ldots,\ddot{\mathbf f}_{T,k}]\in\mathbb R^{r_k\times T}$ and $\widetilde{\mathbf F}_k=[\widetilde{\mathbf f}_{1,k},\ldots,\widetilde{\mathbf f}_{T,k}]$. Similarly, denote $\ddot{\mathbf x}_{t,k}=\widetilde{\mathbf x}_{t,k}/s_{-k}^{1/2}$ and $\ddot{\mathbf X}_k=(\ddot{\mathbf x}_{1,k},...,\ddot{\mathbf x}_{T,k})^\top\in\mathbb R^{T\times d_k}$, $\widetilde{\mathbf X}_k=(\widetilde{\mathbf x}_{1,k},...,\widetilde{\mathbf x}_{T,k})^\top$. Also let $\ddot{\mathbf e}_{t,k}=\widetilde{\mathbf e}_{t,k}/s_{-k}^{1/2}$, $\ddot{\mathbf E}_k=(\ddot{\mathbf e}_{1,k},...,\ddot{\mathbf e}_{T,k})^\top$ and $\widetilde{\mathbf E}_k=(\widetilde{\mathbf e}_{1,k},...,\widetilde{\mathbf e}_{T,k})^\top$. Finally, let $\ddot{\boldsymbol\mu}_k=\widetilde{\boldsymbol\mu}_k/s_{-k}^{1/2}$. Then,
\[
...
members['D5']['highlight_symbols'] = ['\\mathbf D_k', 'd_k^{\\alpha_{k,j}}']
