...
DIRECT['9']['D7']='Theorem 9 imports the small-error assumptions of Theorem 6, whose reference direction U_k,(1) is defined by the loading SVD in (3.8).'
def main():
 save_passages()
 ...
 for x in data['interfaces']:
  for r in x['related_theorems']:
   ...
   if n=='9' and path[0]=='D7':evidence.append(dict(page=20,location='Theorem 6 — inherited small-error conditions'))
