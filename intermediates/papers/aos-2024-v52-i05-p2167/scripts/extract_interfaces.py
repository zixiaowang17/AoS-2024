...
members['D15']['highlight_symbols'] = ['\\mathcal B_{q_1,q_2}^{s,b}', '\\|f\\|_{\\mathcal B_{q_1,q_2}^{s,b}}', '\\alpha_f(j,l,w)']
members['D17']['highlight_symbols'] = ['\\mathcal G', 'L^{-1}=n^{-1}', '\\widehat{\\mathcal F}_{\\mathrm{per}}^{\\beta+1,n^{-\\frac1{2\\beta+d}}}']
members['D19']['highlight_symbols'] = ['\\chi', '\\mathcal G', '\\widehat{\\mathcal F}_{\\mathrm{per}}^{\\beta+1,n^{-\\frac1{2\\beta+d}}}']
