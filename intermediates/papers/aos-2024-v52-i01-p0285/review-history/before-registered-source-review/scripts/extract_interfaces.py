...
Define parameter space $\Theta(K,s):=\{\theta=(\beta^\top,\alpha^\top)^\top\in\mathbb R^{p+q}\mid\gamma\in\mathbb R^K,\beta_j\in\{0,\gamma_1,\ldots,\gamma_K\},\forall j\in[p],\|\beta\|_0\leq s\}$.
