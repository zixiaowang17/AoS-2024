...
members['D2']['highlight_symbols'] = ['\\mathscr P(P,\\mathcal P,s)', '\\left\\|p_\\epsilon^{1/2}-p^{1/2}-\\epsilon sp^{1/2}/2\\right\\|_{L^2(\\lambda)}']
members['D24']['highlight_symbols'] = ['\\Gamma_\\beta^{-1}[\\mathcal C_n^\\beta(\\widehat\\zeta_n)]']
