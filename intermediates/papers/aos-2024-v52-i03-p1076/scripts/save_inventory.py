...
prov={'paper_id': 'aos-2024-v52-i03-p1076', 'title': 'Spectral regularized kernel two-sample tests', 'version': 'arXiv:2212.09201v3', 'source_url': 'https://arxiv.org/pdf/2212.09201v3', 'pdf_pages': 75, 'pdf_sha256': '9037d8bcb2e72b7ef99d19d1d78a7415d8a9be4869ee42089fa5fa10423913ee', 'main_text_end_y': 601.6620483398438};claims=[]
...
def main():
    ...
    pdf=fitz.open(source);assert len(pdf)==75 and hashlib.sha256(source.read_bytes()).hexdigest()==paper['pdf_sha256']
