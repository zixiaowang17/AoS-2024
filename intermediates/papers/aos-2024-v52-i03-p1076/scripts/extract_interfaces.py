...
''',[6],'Section 3 — centered integral operator',{'D7':'The centered integral operator is the inclusion composed with its adjoint, and its expanded form uses R-centering.'},symbols=[r'\mathcal T',r'\Upsilon'],context=r'where $\mathcal T:L^2(R)\to L^2(R)$ is an integral operator defined by $K$ (see Section 3 for details),',shape='Double-centered integral operator on L2(R), not the uncentered Upsilon operator. Kernel-dependent smoothness and spectral rates use this operator.')
...
regularizer_context=r'where the spectral regularizer, $g_\lambda:(0,\infty)\to(0,\infty)$ satisfies $\lim_{\lambda\to0}xg_\lambda(x)\asymp1$ (more concrete assumptions on $g_\lambda$ will be introduced later).'
