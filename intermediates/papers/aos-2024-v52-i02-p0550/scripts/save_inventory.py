...
prov={'paper_id': 'aos-2024-v52-i02-p0550', 'title': 'A general framework to quantify deviations from structural assumptions in the analysis of nonstationary function-valued processes', 'version': 'arXiv:2208.10158v3', 'source_url': 'https://arxiv.org/pdf/2208.10158v3', 'pdf_pages': 86, 'pdf_sha256': '697650c95aaf3025e8e5e76e36053a24c58bf8593272221f7aeb4dc16f652638'}
claims=[]
...
def main():
    ...
    assert len(pdf)==86 and hashlib.sha256(source.read_bytes()).hexdigest()==paper['pdf_sha256']
    for n in range(30):
