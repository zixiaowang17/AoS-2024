...
def main():
    ...
    script = root / 'tooling/skills/statistical-census-html/scripts/build_report.py'
    ...
    try:
        ...
        (aggregate / 'html-reproduction-verification.json').write_text(json.dumps(result, indent=2) + '\n')
